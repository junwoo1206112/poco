...
- [ ] 6.6 Log special block clears as explicit play-log events
...
- [ ] 8.8 Verify special blocks (frozen, stone, clock) behave correctly
- [ ] 8.9 Verify no console errors during extended play
- [ ] 8.10 Run `tools\poko-cli.cmd analyze-playlog` and confirm combat metrics in report
...
- [ ] 9.3 Capture after-fix play log showing `clear` when target score is reached by time end
