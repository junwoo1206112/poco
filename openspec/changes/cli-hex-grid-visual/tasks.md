...
- [ ] 3.1 Open Unity, confirm compilation succeeds.
- [ ] 3.2 Run `tools\poko-cli.cmd analyze-board` (close Unity first) and verify the Markdown report contains a readable hex grid.
- [ ] 3.3 Confirm the grid correctly renders odd-row offset and five distinct tile symbols.
