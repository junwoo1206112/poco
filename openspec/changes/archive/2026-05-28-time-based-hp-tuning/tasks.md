...
- [x] 1.3 Add `balanceProfileId` to `PokoLevelConfig` so generated levels can select a runtime balance profile
...
- [x] 3.3 Update generated, retuned, experiment, applied, and promoted level reports to preserve or display `balanceProfileId`
...
- [x] 5.3 Assign experiment balance profiles: control uses `default`, readability uses `readable`, and combo uses `combo`
