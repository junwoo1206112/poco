...
echo.
echo Usage:
echo   tools\poko-cli.cmd create-core-board [--layout hex] [--scenePath Assets/Scenes/PokoPrototype.unity] [--width 7] [--height 7] [--tileTypes 5] [--spacing 0.95] [--reportPath md/cli-reports/core-board-input.md]
